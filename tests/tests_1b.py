...
def test_addition():
    ...
    assert simple_calculator("add", -100, -300) == -400 # Test for negative numbers
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", -5, 2) == -7   # Test for negative and postiive number
...
def test_division():
    ...
    assert simple_calculator("divide", -100, -400) == 0.25    # Test for negative numbers
    assert simple_calculator("divide", -4, 2) == -2           # Test for negative and positive number
    assert simple_calculator("divide", 0, 30) == 0            # Test for numerator = 0
